    ...
    namespace Lab4
    {   /// <summary>
        /// Database now uses cochroachlabs, same functionality as lab 2.
        /// </summary>
        public class Database : IDataBase
        {
            ...
            static String GetConnectionString()
            {
                ...
                connStringBuilder.Host = "raw-kraken-13056.5xj.cockroachlabs.cloud";
                connStringBuilder.Port = 26257;
                connStringBuilder.SslMode = SslMode.VerifyFull;
                connStringBuilder.Username = "schnei71"; // won't hardcode this in your app
                connStringBuilder.Password = "d14w99g1HJhYBo2A_1wWQg";
